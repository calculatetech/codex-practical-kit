...
- Use one fresh supported-model correctness reviewer. At a severe stop, complete `defect-diagnostic`, include its result with the separate finding handoffs, then halt. Never make a post-commit documentation change.
