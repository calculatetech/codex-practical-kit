...
This is the source of truth for project work. Task identifiers are permanent. Once assigned, a `<PREFIX>-NNN` number is never reused or changed. Move tasks between sections when their status changes. Never mark more than one task active.
