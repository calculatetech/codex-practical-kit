...
<!-- cpk-rule-guard: Review closure is limited to three updates: the reviewed task roadmap transition, matching checksums, and untracked test-result record. -->
...
Review closure is limited to three updates: the reviewed task roadmap transition, matching checksums, and untracked test-result record.
