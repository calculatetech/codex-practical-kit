...
## Skeleton of a Good ExecPlan
    ...
    State whether normal steps can be repeated. If a command fails, stop and report it unless the task explicitly defines recovery.
...
Before review closure, make sure that each revision is consistent across all sections. Add a final note that describes the change and its reason. ExecPlans must describe the work and the reason for it.
