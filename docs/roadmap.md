...
- ⏭ **CPK-002 — Unify ExecPlan and Task Brief ownership.** Reconcile `.agent/PLANS.md`, Plan Mode, Design Preflight, and Task Brief so each task has one plan owner.
...
- ✅ **Design and planning foundation.** Design Preflight, Task Brief, Spec Kit escalation guidance, and repository ExecPlan rules are available.
...
- ✅ **CPK-001 — Make roadmap state authoritative.** The Roadmap Maintainer, template, lifecycle rules, and pre-review terminal state make `docs/roadmap.md` the human source of truth.
