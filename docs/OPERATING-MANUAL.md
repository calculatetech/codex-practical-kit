...
The managed AGENTS block selects the rules for an agent. This manual does not copy those rules.
...
- [Defect diagnostics](../assets/skills/defect-diagnostic/SKILL.md)

## Operations

Use the [README](../README.md) for installation, RepoWise setup, uninstall, and verification commands.

Use [RepoWise notes](REPOWISE.md) for repository setup and opt-out details.
